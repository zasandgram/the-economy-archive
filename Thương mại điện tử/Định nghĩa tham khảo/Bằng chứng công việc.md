...
![[image 9.png|662x255]] Công việc này được gọi là "đào block", thường do các "thợ đào" thực hiện. Nguyên lý cốt lõi của quá trình trong cơ chế PoW là giải quyết một "phương trình toán học phức tạp", với mục tiêu tìm ra cách giải quyết nhanh và hiệu quả nhất
